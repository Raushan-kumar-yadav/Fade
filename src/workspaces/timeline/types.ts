...
export type TimelineAction =
  ...
  | { type: 'COMMIT_MOVE' }
  | { type: 'TRIM_CLIP'; clipId: string; trackId: string; side: 'left' | 'right'; frameDelta: number }
  ...
  | { type: 'UPDATE_INTERACTION'; pendingFrameDelta: number; pendingTrackDelta: number; accumPx: number }
