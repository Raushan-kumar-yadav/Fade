/** toolsApi.ts — client helpers for Text / Shape / Pen / Mask routes */
...
export const shapeApi = {
  add:    (startFrame: number, duration: number, style: ShapeStyle = {}) =>
    post('/clips/shape', { startFrame, duration, style }),
